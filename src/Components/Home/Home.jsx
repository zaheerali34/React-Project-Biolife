  ...
  return (
    <>
      <div className='w-full h-[120vh] bg-[url("./image/main-slide-01.jpg")] bg-cover bg-center bg-no-repeat absolute top-0 flex items-center justify-center'>
        <div className="w-[50vw] h-[65vh] bg-[#ffffffb7] shadow-xl mt-[8rem] px-8 py-3 flex flex-col items-start gap-3 max-[761px]:w-[95vw] max-[761px]:h-[45vh] max-[761px]:items-center max-[761px]:text-center max-[480px]:h-[50%] max-[380px]:h-[67%]">
