  ...
  return (
   <>
      ...
      <div className='w-full h-full bg-[url("./image/banner-grid-01.jpg")] bg-center bg-cover relative max-[990px]:h-[100vh] max-[990px]:w-[100%]'>
        <div className='w-full h-[4rem] bg-[url("./image/bn_grid_01.png")] bg-center bg-cover absolute bottom-[1rem] cursor-pointer hover:shadow-xl hover:shadow-orange-400'>
